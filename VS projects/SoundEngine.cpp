...
SoundEngine::SoundEngine()
{
 ...
 m_PlayerExplodeBuffer.loadFromFile("sound/Wav/big_explosion.wav");
 m_InvaderExplodeBuffer.loadFromFile("sound/Wav/explosion.wav");
 m_ClickBuffer.loadFromFile("sound/Wav/Wav/mouse_click.wav");
